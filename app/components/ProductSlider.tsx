...
const ProductSlider = () => {
  return (
    <Carousel
      ...
      className="mb-12"
    >
      <Link href="/pages/product/890asdasd">
      ...
      <Link href="/pages/product/89sassxxxx0asdasd">
        <div className="w-full px-2">
          <Image
      ...
      <Link href="/pages/product/8900897678asdasd">
        <div className="w-full px-2">
          <Image
      ...
      <Link href="/pages/product/890asdajhkhuyt564sd">
        <div className="w-full px-2">
          <Image
      ...
      <Link href="/pages/product/iii8979iouasd">
        <div className="w-full px-2">
          <Image
